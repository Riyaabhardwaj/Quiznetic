...
const Sidebar = () => {
  ...
  //if inner width is grater than 768px then it will call this function
  useEffect(() => {
    const handleResize = () => {
  ...
  //if sidebar is open and inner width is less than 768 px then it will collapse
   useEffect(() => {
 ...
 const levels = [
  ...
  const handleTechSelect = (techId) => {
    if (selectedTech === techId) {
      setSelectedTech(null);  //all initial values are defined here
  ...
  const submitResult=async()=>{
    ...
    try{
        ...
        toast.info('Saving your resuilt...');
