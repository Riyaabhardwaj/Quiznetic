...
import { ArrowLeft, CheckCircle, Eye, EyeOff, User, Lock,Mail } from 'lucide-react';
                            ...
                            <label className={signupStyles.label}>
                                ...
                                <div className={signupStyles.inputContainer}>
                                    ...
                                    <input type="text" name="name" value={name} onChange={(e) => {
                                        setName(e.target.value); if (errors.name) setErrors((s) => ({
                                            ...s,
                                            name: undefined,
                                        }));
                                    }}
                            ...
                            <label className={signupStyles.label}>
                                ...
                                <div className={signupStyles.inputContainer}>
                                    ...
                                    <input type="email" name="email" value={email} onChange={(e) => {
                                        setEmail(e.target.value); if (errors.email) setErrors((s) => ({
                                            ...s,
                                            email: undefined,
                                        }));
                                    }}
                            ...
                            <label className={signupStyles.label}>
                                ...
                                <div className={signupStyles.inputContainer}>
                                    ...
                                    <input type={showPassword ? 'text' : 'password'} name="password" value={password} onChange={(e) => {
                                        setPassword(e.target.value); if (errors.password) setErrors((s) => ({
                                            ...s,
                                            password: undefined,
                                        }));
                                    }}
