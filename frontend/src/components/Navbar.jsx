...
<div style={{
    backgroundImage:`url($ {navbarStyles.decorativePatternBackground})`,
...
<div className={navbarStyles.container}>
    ...
    <div className={navbarStyles.titleContainer}>
            <div className={navbarStyles.titleBackground}>
                <h1 className={navbarStyles.titleText}>Quiznetic</h1>
            </div>
    </div>
     ...
     <div className={navbarStyles.mobileMenuContainer}>
        <button onClick={()=>setMenuOpen((s)=>!s)} className={navbarStyles.menuToggleButton}>
            {menuOpen ? (
                ...
                navbarStyles.menuIcon
            } />
            )}
        </button>
            {menuOpen && (<div className={navbarStyles.mobileMenuPanel}>
